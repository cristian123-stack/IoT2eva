...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        irDashboard.setOnClickListener {
            ...
            val contrasena: String = findViewById<EditText>(R.id.input_contrasena).text.toString()
            ...
            if (usuario.isNotEmpty() && contrasena.isNotEmpty()) {
                ...
                if (usuario.isEmpty()) {
                    Toast.makeText(this, "No has ingresado un usuario", Toast.LENGTH_SHORT).show()
                }
